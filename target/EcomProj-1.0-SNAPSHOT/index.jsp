    ...
    <img class="d-block w-100" style="height: 300px;" src="images/c1.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
    <img class="d-block w-100" style="height: 300px;" src="images/c2.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
    <img class="d-block w-100" style="height: 300px;" src="images/c3.jpg" alt="Third slide">
    </div>
        <div class="carousel-item">
    <img class="d-block w-100" style="height: 300px;" src="images/c4.jpg" alt="fourth slide">
    </div>
    </div>
                                                    ...
                                                    <div  style="width: 200px;">
                                                        <div class="card" style="margin: 10 ;" width: 300px;">
                                                             <div class="card-body"  style="padding: 0; text-align: center;">
                                                                ...
                                                                <h5 class="card-title" style="margin-left:5px;">${prod.getName()}</h5>
                                                                <h5>Rs&nbsp${prod.getPrice()}</h5>
                                                                <a  href="Product/ViewSingleProduct.jsp?id=${prod.getId()}" class="btn btn-primary" style="color: white; width: 150px; margin-right:  10px;">View</a>
                                                            </div>  
                                                        </div>
                                                                        </div>
